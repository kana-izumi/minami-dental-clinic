      ...
      <article class="blog-page__main">
        <?php if(have_posts()) : ?>
          ...
          <div class="blog-main__inner">
            ...
            <div class="blog-page__info">
              ...
              <div class="blog-page_category"><?php /* 1個だけ出力する例 */ if ( !empty( $tmp_cat = get_the_category() ) ) { echo $tmp_cat[0]->cat_name; } ?></div>
            </div>
        ...
        <!-- ページネーション -->
          <div class="blog-page__pager">
            ...
            <?php endif; ?>
            <li>
              <a class="blog-page__pagination-all" href="<?php echo esc_url(home_url('/'))?>news">
              記事一覧
              </a>
            </li>
